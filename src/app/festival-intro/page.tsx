...
const companyLogosRow3 = allCompanyLogos.slice(9, 13)  // 신한은행까지
const companyLogosRow4 = allCompanyLogos.slice(13, 17)
const companyLogosRow5 = allCompanyLogos.slice(17, 19)
