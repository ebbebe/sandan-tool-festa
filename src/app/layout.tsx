...
export const metadata: Metadata = {
  title: "2026 산단툴페스타 | INDUSTRIAL COMPLEX TOOLFESTA",
  description: "2026년 11월 15일-16일, 소래포구 해오름 광장에서 개최되는 산업단지 툴페스타. 산업용 제품·부품·소재·공구 전시 및 채용 박람회",
  keywords: "산단툴페스타, 산업박람회, 공구전시회, 채용박람회",
  verification: {
  ...
  openGraph: {
    title: "2026 산단툴페스타",
    description: "2026년 11월 15일-16일, 소래포구 해오름 광장에서 개최되는 산업단지 툴페스타",
    images: [
      {
        url: "/assets/meta.png",
        width: 1200,
