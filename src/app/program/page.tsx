          ...
          <div className="space-y-16">
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <h3 style={{ fontFamily: 'NanumSquare, sans-serif' }} className="text-2xl font-black text-[#2c2c2d] leading-none">
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-8 max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Experience 1 */}
            <div>
              <h3 style={{ fontFamily: 'NanumSquare, sans-serif' }} className="text-2xl font-black text-[#2c2c2d] mb-4 text-center">
                가족 중심 시민체험 프로그램
              </h3>
              <img src={imgExperience1} alt="" className="rounded-xl w-full h-[375px] object-cover mb-4" />
              <div style={{ fontFamily: 'NanumSquare, sans-serif' }} className="text-base md:text-[18px] text-[#2c2c2d]">
                <ul className="list-disc space-y-2 ml-6">
