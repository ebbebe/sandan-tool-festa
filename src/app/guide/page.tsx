        ...
        <div className="container mx-auto px-8 max-w-7xl">
          ...
          <div className="mb-12">
            ...
            <div className="flex justify-between items-start">
              <div>
                <p style={{ fontFamily: 'Wanted Sans, WantedGothic, sans-serif' }} className="text-xl text-[#2c2c2d]">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-8 max-w-7xl">
          ...
          <div className="text-center mb-16">
            <p style={{ fontFamily: 'Wanted Sans, WantedGothic, sans-serif' }} className="text-lg text-[#2c2c2d] leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <p style={{ fontFamily: 'Wanted Sans, WantedGothic, sans-serif' }} className="text-lg text-[#2c2c2d]">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-8 max-w-7xl">
          ...
          <div className="bg-[#d9d9d9] rounded-[13px] h-[501px] relative flex items-center justify-center">
            <div className="text-center">
              <p style={{ fontFamily: 'Wanted Sans, WantedGothic, sans-serif' }} className="text-[40px] font-black text-[#be2e2e] mb-8">
                제공 예정
              </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-8">
            <div className="text-center">
              <h4 style={{ fontFamily: 'Wanted Sans, WantedGothic, sans-serif' }} className="text-2xl font-black text-[#2c2c2d] mb-2">
                A ZONE
              </h4>
              <p style={{ fontFamily: 'Wanted Sans, WantedGothic, sans-serif' }} className="text-lg text-[#2c2c2d]">
