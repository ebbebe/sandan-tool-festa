            ...
            <div className="relative z-10 p-8 md:p-10 text-white">
              ...
              <div className="text-center mb-8">
                ...
                <div className="flex items-center justify-center gap-3 mb-8">
                  <h1 className="text-xl md:text-2xl font-bold" style={{ fontFamily: 'NanumSquare, sans-serif' }}>
                    인하대학교 산학협력단
                  </h1>
                </div>

                {/* Title */}
                <h2 className="text-xl md:text-2xl font-bold leading-tight mb-12" style={{ fontFamily: 'NanumSquare, sans-serif' }}>
              ...
              {/* 강의 내용 Section */}
              <div className="mb-8">
                <h3 className="text-lg font-bold mb-8 text-center" style={{ fontFamily: 'NanumSquare, sans-serif' }}>
                  강의 내용
                </h3>
                <div className="space-y-3 text-sm md:text-base">
                  <div className="flex items-start justify-center">
                    <span className="font-bold w-8 flex-shrink-0" style={{ fontFamily: 'NanumSquare, sans-serif' }}>1.</span>
                    <span className="flex-1 max-w-xs">생성형 AI를 활용한 스마트한 미래생활</span>
                  </div>
                  <div className="flex items-start justify-center">
                    <span className="font-bold w-8 flex-shrink-0" style={{ fontFamily: 'NanumSquare, sans-serif' }}>2.</span>
                    <span className="flex-1 max-w-xs">산업현장의 혁신적인 AI 적용사례</span>
                  </div>
                  <div className="flex items-start justify-center">
                    <span className="font-bold w-8 flex-shrink-0" style={{ fontFamily: 'NanumSquare, sans-serif' }}>3.</span>
                    <span className="flex-1 max-w-xs">제조 데이터셋 전처리 및 AI 활용</span>
                  </div>
                  <div className="flex items-start justify-center">
                    <span className="font-bold w-8 flex-shrink-0" style={{ fontFamily: 'NanumSquare, sans-serif' }}>4.</span>
